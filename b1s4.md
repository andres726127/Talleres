...
RESPUESTAS
PREGUNTA 1: El valor es negativo.
PREGUNTA 2: existe una relación inversa entre el peso y la tensión sistólica en los datos. Es decir, a medida que el peso aumenta, la tensión sistólica tiende a disminuir.
Esto podría implicar que en la muestra de datos, las personas con mayor peso tienen una menor tensión sistólica
PREGUNTA 3: denX es la suma de los cuadrados de las diferencias de los valores de X respecto a su media.
denY hace lo mismo pero para la variable Y.
Finalmente, se multiplican ambos términos, obteniendo el denominador de la fórmula de Pearson, que es la raíz cuadrada de la multiplicación de los términos de la varianza de X y Y
PREGUNTA 4: El coeficiente de correlación de Pearson al ser negativo, reflejaría una relación inversa entre el peso y la tensión sistólica, es decir, cuando el peso disminuye, la tensión sistólica tiende a aumentar.
​
